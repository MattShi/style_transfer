#THIS IS A BACK-UP FROM https://github.com/hwalsuklee/tensorflow-style-transfer#
ANY FURTHER INFORMATION ,PLEASE GO TO https://github.com/hwalsuklee/tensorflow-style-transfer
THIS IS ONLY FOR TESTING

# SETTING
0)sudo apt-get -y install python3-pip

1) TENSORFLOW SETTING  
   pip3 install --upgrade tensorflow requests
   or pip3 install --upgrade tensorflow-gpu
   IF YOU ARE USING A HIGHER VERSION OF CUDA(>9.0) ,PLEASE FOLLOW https://www.tensorflow.org/install/source TO INSTALL 
   TENSORFLOW FROM SOURCE.

2) python3 -mpip install matplotlib  
   
3)sudo apt-get update
sudo apt-get install python3-tk

4)sudo apt-get install python3-scipy
5) pip3 install keras_applications==1.0.4 --no-deps
